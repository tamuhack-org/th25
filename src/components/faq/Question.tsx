...
const QuestionItem: React.FC<QuestionProps> = ({ item }) => {
    ...
    return (
        <>
            ...
            >
                <summary
                    className={`text-md flex cursor-pointer items-center rounded-t-[38px] bg-[#F5BFE4] py-2 font-medium md:text-xl ${open ? '' : 'rounded-b-[38px] transition-all delay-[170ms]'}`}
