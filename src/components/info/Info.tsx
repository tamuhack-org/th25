const Info = () => {
    return (
        <div className="relative grid-cols-2 grid-rows-2 lg:grid">
            ...
            <div className="col-span-1 col-start-2 row-span-1 row-start-1">
                <h2>General Info</h2>
                <p>
                    TAMUhack is a 24-hour event where teams create innovative
                    software and hardware solutions to real-world problems in a
                    community of mentorship.
                </p>
                <h3>Location</h3>
                <p>Bethancourt Ballroom (MSC 2300)</p>
                <p>730 Olsen Blvd, College Station, TX 77845</p>
                <a href="#">Building Map & Parking</a>
            </div>
            <div className="col-span-1 col-start-1 row-span-1 row-start-2">
                <h2>Hardware</h2>
                <p>
                    At TAMUhack 2025, hardware will be a week-long hackathon
                    from January 19th to January 26th.
                </p>
                <p>
                    Teams will have a week to work on their project to allow
                    more time for debugging and troubleshooting. On January
                    26th, teams will showcase their project in specific
                    challenges ranging from medical devices, communication,
                    beginner, or the general track itself.
                </p>
                <p>
                    TAMUhack will be providing hardware supplies on a first
                    come, first served basis. Using personal/outside hardware is
                    allowed, but it is your responsibility to obtain it!
                </p>
            </div>
        </div>
    );
